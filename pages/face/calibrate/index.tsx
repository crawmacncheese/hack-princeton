...
export default function FaceCalibratePage() {
  ...
  return (
    <div className="px-6 pb-20 pt-10 sm:px-10 md:px-14">
        ...
        <div className="ml-10 flex">
          <div>
            <div className="mb-2 flex items-center justify-center">
              ...
              <Button
                ...
                onClick={() => navigator.clipboard.writeText(minScores)}
                text="Copy"
              />
            </div>
            <div className="flex">
              <TextArea
                className="h-[460px] w-[220px] text-xs"
                text={minNames}
                readOnly={true}
              />
              <TextArea
                className="h-[460px] w-[100px] text-xs"
                text={minScores}
                readOnly={true}
              />
            </div>
          ...
          <div className="ml-5">
            <div className="mb-2 flex items-center justify-center">
              ...
              <Button
                className="py-1 text-xs"
                onClick={() => navigator.clipboard.writeText(maxScores)}
                text="Copy"
              />
            </div>
            <div className="flex">
